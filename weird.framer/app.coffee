...
animatePage = (page, pageTo) ->
	blah = new Animation page,
	y: page.y-100
	wef = new Animation pageTo,
	y: pageTo.y-200
	blah.start()
	wef.start()
#pageUp = (page) ->
...
onToTheNext = (currentImage) ->
	if count == 0
		animatePage(yearPage,monthPager)
	else if count == 1
		animatePage(monthPager,dayPager)
	else if count == 2
		animatePage(dayPager,timePager)
	else if count == 3
		animatePage(timePager,minutePager)
	else if count == 4
		animatePage(minutePager,secondsPager)
	else if count == 5
		animatePage(secondsPager,null)
...
yearPage = new PageComponent
	...
	x: screenTemplate.width/2 - (sketch3.$2013.width/2)
...
dayPager = new PageComponent
	...
	scrollVertical: false
	x: screenTemplate.width/2 - (sketch3.$1.width/2)
	y:480
timePager = new PageComponent
	...
	scrollVertical: false
	x: screenTemplate.width/2 - (sketch3.$1am.width/2)
	y:580
minutePager = new PageComponent
	...
	scrollVertical: false
	x: screenTemplate.width/2 - (sketch3.m1.width/2)
	#y: 370 - (i* (sketch3.apr.height+40))
	y:680
